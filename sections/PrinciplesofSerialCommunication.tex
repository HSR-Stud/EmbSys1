...
\begin{minipage}{10cm}
	\begin{itemize}
		...
		\item Logic Levels, Positive Level (")
...
\end{itemize}
\begin{tabular}{ccc}
	\includegraphics[width=6cm]{images/Connectors_RS.png} & \includegraphics[width=4cm]{images/pin_RS.png} & \includegraphics[width=6cm]{images/cable_RS.png}\\
\end{tabular}
