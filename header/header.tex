...
% Seitenränder
\usepackage[left=1.27cm,right=1.27cm,top=0.8cm,bottom=0.8cm,includeheadfoot]{geometry}
% Sprachpaket
...
\usepackage[colorlinks=true,linkcolor=black]{hyperref}               % Erstellt Verweise innerhalb und nach außerhalb eines PDF Dokumentes.									
...
%\newcommand{\embsys}[1]{$_{\textcolor{blue}{\mbox{\small{ EmbSys S. #1}}}}$}
\newcommand{\embsys}[2]{\textcolor{blue}{\mbox{\small EmbSys S:{ #1} K:{ #2}}}}
